...
# Jupiter
src = "/Users/guillaumebertrand/Documents/perso/astro/jupiter/"
...
# Mars
src = "/Users/guillaumebertrand/Documents/perso/astro/mars/"
dest = "assets/images/photos/"
for root, dirs, files in os.walk(src, topdown=False):
   for name in files:
      filename, file_extension = os.path.splitext(name)
...
# Saturne
src = "/Users/guillaumebertrand/Documents/perso/astro/saturn/"
dest = "assets/images/photos/"
for root, dirs, files in os.walk(src, topdown=False):
   for name in files:
      filename, file_extension = os.path.splitext(name)
...
# unranus
src = "/Users/guillaumebertrand/Documents/perso/astro/uranus/"
dest = "assets/images/photos/"
for root, dirs, files in os.walk(src, topdown=False):
   for name in files:
      filename, file_extension = os.path.splitext(name)
...
# Venus
src = "/Users/guillaumebertrand/Documents/perso/astro/venus/"
dest = "assets/images/photos/"
for root, dirs, files in os.walk(src, topdown=False):
   for name in files:
      filename, file_extension = os.path.splitext(name)
